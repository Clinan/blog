  ...
  <main class="home" aria-labelledby="main-title">
    ...
    >
      ...
      <div
              ...
              :key="index"
      >
        <router-link :to="feature.link" style="display: inline">
          <h2>{{ feature.title }}</h2>
          <p>{{ feature.details }}</p>
        </router-link>
      </div>
    ...
    <div
      ...
      v-if="data.footer"
    >
      {{ data.footer }} <a href="http://www.beian.gov.cn/portal/registerSystemInfo"  class="footer" target="_blank">浙ICP备18027774号-2</a>
      </br>
