...
![dt_2](https://cdn.clinan.xyz/dt_2.png)
...
![dt_3](https://cdn.clinan.xyz/dt_3.png)
...
![dt_4](https://cdn.clinan.xyz/dt_4.png)
...
![dt_5](https://cdn.clinan.xyz/dt_5.png) 
...
![dt_6](https://cdn.clinan.xyz/dt_6.png) 
...
![dt_7](https://cdn.clinan.xyz/dt_7.png) 

接下来，用户的读操作就会得到 v1。这就叫一致性。

![dt_8](https://cdn.clinan.xyz/dt_8.png) 

问题是，用户有可能向 G2 发起读操作，由于 G2 的值没有发生变化，因此返回的是 v0。G1 和 G2 读操作的结果不一致，这就不满足一致性了。

![dt_9](https://cdn.clinan.xyz/dt_9.png)

为了让 G2 也能变为 v1，就要在 G1 写操作的时候，让 G1 向 G2 发送一条消息，要求 G2 也改成 v1。

![dt_10](https://cdn.clinan.xyz/dt_10.png) 

这样的话，用户向 G2 发起读操作，也能得到 v1。

![dt_11](https://cdn.clinan.xyz/dt_11.png) 
...
- Basically Available（基本可用），AP。

- Soft state（软状态）, AP。数据可以有中间状态，在数据没有传输到的情况下，允许数据出现不一致。
- Eventually consistent（最终一致性）。只要保证数据是最终一直的就可以。
...
![dt_12](https://cdn.clinan.xyz/dt_12.png) 
...
![dt_13](https://cdn.clinan.xyz/dt_13.png) 
...
- 单点故障问题
  ...
  ![dt_16](https://cdn.clinan.xyz/dt_16.png) 
...
![dt_17](https://cdn.clinan.xyz/dt_17.png) 
...
![dt_18](https://cdn.clinan.xyz/dt_18.png)
...
![dt_20](https://cdn.clinan.xyz/dt_20.png)
...
![dt_21](https://cdn.clinan.xyz/dt_21.png) 
...
![dt_23](https://cdn.clinan.xyz/dt_23.png)



一次消息发送的时序图：

![dt_24](https://cdn.clinan.xyz/dt_24.png)
...
![dt_25](https://cdn.clinan.xyz/dt_25.png)
...
![dt_26](https://cdn.clinan.xyz/dt_26.png)
...
![dt_27](https://cdn.clinan.xyz/dt_27.png)
...
![dt_28](https://cdn.clinan.xyz/dt_28.png)
...
![Saga 模式](https://cdn.clinan.xyz/dt_1.png) 
...
![Seata](https://cdn.clinan.xyz/dt_0.png)
...
Seata 会有 4 种分布式事务解决方案，分别是 AT 模式、TCC 模式、Saga 模式和 XA 模式。![dt_29](https://cdn.clinan.xyz/dt_29.png) 
...
![dt_30](https://cdn.clinan.xyz/dt_30.png)
...
![dt_31](https://cdn.clinan.xyz/dt_31.png) 

找到项目所在目录，选中并打开：

![dt_32](https://cdn.clinan.xyz/dt_32.png) 

项目结构如下：

![dt_33](https://cdn.clinan.xyz/dt_33.png) 
...
![dt_35](https://cdn.clinan.xyz/dt_35.png) 

库存：

![dt_36](https://cdn.clinan.xyz/dt_36.png) 
...
![dt_34](https://cdn.clinan.xyz/dt_34.png) 

查看数据库数据：

余额：

![dt_37](https://cdn.clinan.xyz/dt_37.png) 

库存：

![dt_38](https://cdn.clinan.xyz/dt_38.png) 

订单：

![dt_39](https://cdn.clinan.xyz/dt_39.png) 
...
![dt_40](https://cdn.clinan.xyz/dt_40.png)

看下用户余额：

![dt_47](https://cdn.clinan.xyz/dt_47.png) 

因为扣款失败，因此这里没有扣减

来看下库存数据：

![dt_41](https://cdn.clinan.xyz/dt_41.png) 
...
![dt_42](https://cdn.clinan.xyz/dt_42.png) 



然后解压即可，其目录结构如下：

![dt_43](https://cdn.clinan.xyz/dt_43.png) 
...
![dt_44](https://cdn.clinan.xyz/dt_44.png) 
...
![dt_46](https://cdn.clinan.xyz/dt_46.png)
